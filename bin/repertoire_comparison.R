...
datadir <- "."
all_files <- system(paste0("find '",datadir,"' -name '*.tsv'"), intern=T)
...
# Determining number of bootsraps
nboot = 1000
...
# TODO: modify variables to fit newest version of alakazam and shazam packages
