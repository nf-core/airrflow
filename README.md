# ![nf-core/bcellmagic](docs/images/nf-core-bcellmagic_logo_light.png#gh-light-mode-only) ![nf-core/bcellmagic](docs/images/nf-core-bcellmagic_logo_dark.png#gh-dark-mode-only)
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/bcellmagic -profile test,YOURPROFILE --outdir <OUTDIR>
    ```
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/bcellmagic --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
    ```
