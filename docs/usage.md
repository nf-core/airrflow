...
The required input file is a sample sheet in TSV format (tab separated). The columns `sample_id`, `filename_R1`, `filename_R2`, `subject_id`, `species` and `pcr_target_locus` are required. An eample samplesheet is:
...
sample01	sample1_S8_L001_R1_001.fastq.gz	sample1_S8_L001_R2_001.fastq.gz	sample1_S8_L001_I1_001.fastq.gz	Subject02	human	IG	Drug_treatment	baseline	p
```
