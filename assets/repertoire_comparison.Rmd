...
subdirectory [clonal_analysis/clonal_assignment/all_reps_clone_report/repertoires](clonal_analysis/clonal_assignment/all_reps_clone_report/repertoires).
...
- Report summarizing the repertoire properties for all the samples [clonal_analysis/clonal_assignment/all_reps_clone_report/index.html](clonal_analysis/clonal_assignment/all_reps_clone_report/index.html).
...
if (any(is.na(tab_seqs_assembled$sample_id))) {
  stop("sample_id column not found in Table_sequences_assembled.tsv")
}
