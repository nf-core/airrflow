...
family <- countGenes(df_all, gene="v_call", groups=c("sample_id","subject_id"), mode="family")
...
family <- countGenes(df_all, gene="v_call", groups=c("sample_id","subject_id"), mode="gene")
