...
g2 <- ggplot(family, aes(x=gene, y=clone_freq, fill=gene)) +
  ...
  ylab("Frequency") +
  xlab("") +
  facet_wrap(vars(treatment, patient), scales="free_x")
g2
...
```{r, echo=F, fig.width=8, fig.asp=0.8, fig.align='center'}
...
g2 <- ggplot(family, aes(x=gene, y=clone_freq, fill=gene)) +
  ...
  ylab("Frequency") +
  xlab("") +
  facet_grid(cols=vars(treatment, patient), rows=vars(population))
g2
...
```{r, echo=F, fig.width=7, fig.asp=0.8, fig.align='center'}
...
g2 <- ggplot(family, aes(x=gene, y=clone_freq, fill=gene)) +
  ...
  ylab("Frequency") +
  xlab("") +
  facet_wrap(vars(treatment,patient), scales="free_x", ncol = 1) +
