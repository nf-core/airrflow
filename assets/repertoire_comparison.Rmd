...
number of unique sequences in that subject (By Patient) or in the B-cell sample (By Cell Population). 

To correct for the different number of sequences in each of the samples, the Bootstrapping technique was employed, 
in which 1000 random bootstrap samples were taken, with size the number of sequences in the sample with less sequences (N). 
