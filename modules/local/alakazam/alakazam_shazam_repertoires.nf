process ALAKAZAM_SHAZAM_REPERTOIRES {
    ...
    conda (params.enable_conda ? "conda-forge::r-base=4.1.2 bioconda::r-alakazam=1.2.0 bioconda::r-shazam=1.1.0 conda-forge::r-kableextra=1.3.4 conda-forge::r-knitr=1.33 conda-forge::r-stringr=1.4.0 conda-forge::r-dplyr=1.0.6" : null)              // Conda package
    ...
    "${task.process}":
        ...
        kableextra: \$(Rscript -e "library(kableextra); cat(paste(packageVersion('kableextra'), collapse='.'))")
        stringr: \$(Rscript -e "library(stringr); cat(paste(packageVersion('stringr'), collapse='.'))")
